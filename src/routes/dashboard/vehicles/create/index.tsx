                ...
                <div className="relative w-full max-w-6xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-6 mb-8">
                        ...
                        <Card
                            ...
                            onClick={() =>
                                navigate({
                                    to: "/dashboard/vehicles/create/manual",
                                })
                            }
                        >
                            ...
                            <div className="relative">
                                ...
                                <p className="text-muted-foreground mb-6 leading-relaxed">
                                    Add vehicles manually with full control over
                                    their details. Perfect when you need to
                                    register a few vehicles or test the system
                                    setup.
                                </p>
                                ...
                                <ul className="space-y-3 mb-8">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span className="text-sm text-foreground">
                                            Enter vehicle information step by
                                            step
                                        </span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <Settings className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                                        <span className="text-sm text-foreground">
                                            Useful for testing or adding one-off
                                            vehicles
                                        </span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <Settings className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                                        <span className="text-sm text-foreground">
                                            Complete flexibility — no automation
                                            involved
                                        </span>
                                    </li>
                                </ul>
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                <p className="text-muted-foreground mb-6 leading-relaxed">
                                    Let AI handle the heavy lifting and speed up
                                    vehicle registration. Automatically extract
                                    details, get smart suggestions, and minimize
                                    manual input.
                                </p>
                                ...
                                <ul className="space-y-3 mb-8">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span className="text-sm text-foreground">
                                            Auto-fill vehicle details from
                                            documents or images
                                        </span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                    ...
                                    <li className="flex items-start gap-3">
                                        <Zap className="w-5 h-5 text-teal-600 mt-0.5 flex-shrink-0" />
                                        <span className="text-sm text-foreground">
                                            Save time by reducing repetitive
                                            data entry
                                        </span>
                                    </li>
                                </ul>
